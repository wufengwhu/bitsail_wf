...
import com.bytedance.bitsail.connector.legacy.factory.DataCollectorThreadFactory;
...
@Slf4j
public abstract class AbstractAllLookUpFunction extends RichFlatMapFunction<Row, Row> {
    ...
    public AbstractAllLookUpFunction(
            String[] fieldNames,
            String[] keyNames,
    ...
    public void open(Configuration context) throws Exception {
        ...
        es = new ScheduledThreadPoolExecutor(1, new DataCollectorThreadFactory("cache-all-reload"));
    ...
    public Row fillData(Object sideInput) {
        ...
        Row row = new Row(fieldsName.length);
