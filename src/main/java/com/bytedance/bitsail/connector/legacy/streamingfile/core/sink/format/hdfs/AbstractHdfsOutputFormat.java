...
import static com.bytedance.bitsail.connector.legacy.streamingfile.common.constants.StreamingFileSystemMetricsNames.*;
...
public abstract class AbstractHdfsOutputFormat<IN extends Row> extends HadoopOutputFormatCommonBase<IN> {
    ...
    transient org.apache.flink.runtime.fs.hdfs.HadoopFileSystem hadoopFileSystemWrapper;
    transient org.apache.flink.runtime.fs.hdfs.HadoopDataOutputStream hadoopDataOutputStream;
...
//        System.out.println(Thread.currentThread().getId() + " ##### get record size xxxx = " + recordSize);
...
//            System.out.println(Thread.currentThread().getId() + " ##### record count >= 100 and count= " + recordCount);
            recordCount = 0;
            recordSize = 0;
        }
    }
...
//        hadoopFileSystemWrapper = new HadoopFileSystem(hadoopFileSystem);
    }
...
//        hadoopDataOutputStream = new HadoopDataOutputStream(this.outputStream);
