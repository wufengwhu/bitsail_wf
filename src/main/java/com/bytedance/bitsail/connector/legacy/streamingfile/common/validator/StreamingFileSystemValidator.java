...
public class StreamingFileSystemValidator extends ConnectorDescriptorValidator {
    ...
    public static final String HDFS_DUMP_TYPE_ORC = "hdfs.dump_type.orc";
    ...
    public static final Set<String> HDFS_SUPPORT_DYNAMIC_PARTITIONS = ImmutableSet.of(
            HDFS_DUMP_TYPE_JSON, HDFS_DUMP_TYPE_DEBEZIUM_JSON,
            HDFS_DUMP_TYPE_MSGPACK, HDFS_DUMP_TYPE_BINARY, HDFS_DUMP_TYPE_TEXT, HDFS_DUMP_TYPE_ORC);
