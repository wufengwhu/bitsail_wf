...
import com.bytedance.bitsail.core.lookup.DataLookUpBuilderFactory;
import com.bytedance.bitsail.core.reader.DataReaderBuilderFactory;
import com.bytedance.bitsail.core.transformer.DataTransformerBuilderFactory;
...
public class UnificationJob<T> implements Serializable {
    ...
    private final BitSailConfiguration lookupConfiguration;
    ...
    private DataLookUpDAGBuilder dataLookUpDAGBuilder;
    ...
    public UnificationJob(BitSailConfiguration globalConfiguration, CoreCommandArgs coreCommandArgs) {
        ...
        this.lookupConfiguration = execution.getLookupConfiguration();
    ...
    private void prepare() throws Exception {
        ...
        if (globalConfiguration.get(CommonOptions.JOB_HAS_TRANSFORM)) {
            dataTransformDAGBuilders = DataTransformerBuilderFactory
                    .getTransformerDAGBuilderList(mode,
                            readerConfigurations,
                            packageManager);
        }

        // TODO add lookup logic
        if (globalConfiguration.get(CommonOptions.JOB_HAS_LOOKUP)) {
            dataLookUpDAGBuilder = DataLookUpBuilderFactory
                    .getDataLookUpDAGBuilder(mode,
                            lookupConfiguration,
                            packageManager);
        }
